...
def test_server():
    ...
    # Test each tool
    tools = [
        ("⚡ Quick Stats", server.mcp._tools['get_quick_stats']['func']),
        ("📊 CPU Information", server.mcp._tools['get_cpu_info']['func']),
        ("💾 Memory Information", server.mcp._tools['get_memory_info']['func']),
        ("💿 Disk Usage", server.mcp._tools['get_disk_usage']['func']),
        ("🔄 Running Processes (top 5)", lambda: server.mcp._tools['get_running_processes']['func'](5)),
        ("🖥️  System Information", server.mcp._tools['get_system_info']['func']),
        ("🌐 Network Information", server.mcp._tools['get_network_info']['func']),
    ]
